package com.atharvasystem.bleembeddedsample.Utility;
...
public class SampleGattAttributes {
    ...
    static {
        // Sample Services.
        attributes.put("0000ffe0-0000-1000-8000-00805f9b34fb", Constants.EXTRAS_YOUR_UUID);         // Change your UUID here
